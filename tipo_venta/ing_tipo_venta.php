...
<html>
<head>
    <title>Ingresos Tipo Venta</title>
...
<header class="container">
    ...
    <nav class="navbar navbar-default">
        <div class="row">
            <div class="col-lg-12"><h1 class="text-center"><a href="http://10.95.17.114/paneles"><img src="../paris.png" width="140px" height="100px"></a>Ingresos Tipo Venta</h1></div>
        </div>
        ...
        <form class="row" method="get" action="ing_tipo_venta.php">
...
if(isset($_GET['fecha']) && isset($_GET['anterior'])){
    ...
    echo '</tr>';
    echo '</thead>';
    tipoventa($fecha, $fechaAnt, $venta);
    echo "</table>";
